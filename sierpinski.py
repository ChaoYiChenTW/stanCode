...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order: how many sierpinski triangle to do
	:param length: the length of triangles
	:param upper_left_x: the position of the upper left triangle
	:param upper_left_y: the position of the upper left triangle
	"""
	if order <= 0:
		pass
	else:
